...
json_full = 'tests/test_data/file1_test.json'
json_some_equall = 'tests/test_data/file2_test.json'
json_full_anotherkeys = 'tests/test_data/file3_test.json'
json_empty = 'tests/test_data/file4_test.json'
yaml_full = 'tests/test_data/file1_test.yaml'
yaml_some_equall = 'tests/test_data/file2_test.yaml'
yaml_full_anotherkeys = 'tests/test_data/file3_test.yaml'
yaml_empty = 'tests/test_data/file4_test.yaml'
